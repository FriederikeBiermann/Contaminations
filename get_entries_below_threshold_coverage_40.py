...
#print(f"Rows: {data_without_manual_review.shape[0]}, Columns: {data_without_manual_review.shape[1]}")
...
#print(f"Rows: {data_prokaryotes_long_contaminations.shape[0]}, Columns: {data_prokaryotes_long_contaminations.shape[1]}")
#data_prokaryotes_long_contaminations.to_csv(f"{file_path_detailed_data[:-4]}_long_contaminations_from_prokaryotes.csv")


data_prokaryotes_long_contaminations_without_known_hit = pd.read_csv(f"{file_path_detailed_data[:-4]}_long_contaminations_from_prokaryotes_coverage_less_100.csv")
data_prokaryotes_long_contaminations_without_known_hit_40 = data_prokaryotes_long_contaminations_without_known_hit[data_prokaryotes_long_contaminations_without_known_hit['coverage'] < 80]

print(f"Rows: {data_prokaryotes_long_contaminations_without_known_hit_40.shape[0]}, Columns: {data_prokaryotes_long_contaminations_without_known_hit.shape[1]}")

data_prokaryotes_long_contaminations_without_known_hit_40.to_csv(f"{file_path_detailed_data[:-4]}_long_contaminations_from_prokaryotes_coverage_less_80.csv")
