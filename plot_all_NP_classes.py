...
mibig_threshold = 0.3
data = "Data/Refseq_genbank_over_5000_with_gene_annotations_antismash_out_positives_antismash_output_analysis.csv"
...
plt.ylabel("Counts")
plt.title("Putative BGCs by Class")
...
plt.savefig(
    "gx_details_refseq.20230416_contaminations_from_prokaryotes_with_antismash_80_coverage_only_hits_product_classes.svg"
)
